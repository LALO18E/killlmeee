            ...
            <div class="col s12 m6 l4" id="prod-${p.id}">
                <div class="card hoverable">
                    ...
                    p.id
                        ...
                        <div class="admin-actions" style="display:${
                            user ? "flex" : "none"
                        }; position:absolute; top:10px; right:10px; gap:5px;">
                            <a class="btn-floating blue btn-small" onclick="window.editarProducto('${
                                p.id
                            }')"><i class="material-icons">edit</i></a>
                            <a class="btn-floating red btn-small" onclick="window.eliminarProducto('${
                                p.id
